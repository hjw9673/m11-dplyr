...
setwd("~/Desktop/INFO201/m11-dplyr/exercise-8")
...
print(pulitzer %>% filter(Pulitzer.Prize.Winners.and.Finalists..2004.2014 == max(Pulitzer.Prize.Winners.and.Finalists..2004.2014)) %>% select(Newspaper))
...
pulitzer %>% filter(Pulitzer.Prize.Winners.and.Finalists..2004.2014 > 4) %>% filter(Change.in.Daily.Circulation..2004.2013 == min(Change.in.Daily.Circulation..2004.2013)) %>% select(Newspaper)
